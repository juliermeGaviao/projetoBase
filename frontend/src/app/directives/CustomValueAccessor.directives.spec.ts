...
import { CustomValueAccessorDirective, directiveFunction } from './CustomValueAccessor.directives'
...
describe('CustomValueAccessorDirective', () => {
  ...
  beforeEach(() => {
    mockElementRef = { nativeElement: { value: '' } } as any

    mockRenderer = { setProperty: jest.fn() } as any
  ...
  describe('handleInput', () => {
    it('should handle new input value', () => {
      directive.handleInput('new value')
  ...
  describe('handleChange', () => {
    it('should handle change input value', () => {
      directive.handleChange('new value')
...
describe('directiveFunction', () => {
  it('should get custom directive', () => {
